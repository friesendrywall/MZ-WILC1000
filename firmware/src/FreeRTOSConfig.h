...
#define configISR_STACK_SIZE                    ( 786 )
...
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() T6CON = 0;    T6CONbits.TCKPS = 7;    T6CONbits.T32 = 1;    PR6 = 0xFFFFFFFF;    T6CONSET = _T6CON_ON_MASK
#define portGET_RUN_TIME_COUNTER_VALUE() (TMR6)
#define configCOMMAND_INT_MAX_OUTPUT_SIZE 1536

#if ( configUSE_TRACE_FACILITY == 1 )
#ifndef ASSEMBLYINCLUDE
#ifndef __PRODUCTION
